...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> latestNews = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return a list of {@link News} object that has been built up from
    ...
    private static List<News> extractFeatureFromJson(String newsJSON){
        ...
        try {
            ...
            Log.i(LOG_TAG, "test to get response ");
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // key called "results", which represents a list of all news values
